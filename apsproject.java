...
public class LibraryManagementSystem_Fine {
    ...
    static void adminMenu(Scanner sc, String booksFile, String issuedFile) throws IOException {
        while (true) {
            System.out.println("\n--- Admin Menu ---");
    ...
    static void studentMenu(Scanner sc, String booksFile, String issuedFile) throws IOException {
        while (true) {
            System.out.println("\n--- Student Menu ---");
    ...
    static void issueBook(Scanner sc, String booksFile, String issuedFile) throws IOException {
        System.out.print("Enter book title: ");
        String title = sc.nextLine();
        ...
        while ((line = br.readLine()) != null) {
            ...
            if (p[0].equalsIgnoreCase(title) && p[2].equals("available")) {
                p[2] = "issued";
                issued = true;
                BufferedWriter ibw = new BufferedWriter(new FileWriter(issuedFile, true));
    ...
    static void returnBook(Scanner sc, String booksFile, String issuedFile) throws IOException {
        System.out.print("Enter book title: ");
        String title = sc.nextLine();
        System.out.print("Enter your name: ");
        String student = sc.nextLine();
